...
const dataDiv = document.querySelector('.products');

let outputData = data.map(item => {
    const { photo, superHost, type, rating, title } = item;
    // let shortStr = title.substr(0, 30);
    return `<div class='item'>
    <div class='photo-container'>
      <img src=${photo} class='photo' alt=${title}>
    </div>
    <div class='other-details space-between-center'>
     <h3 class=${superHost ? 'superhost' : 'not-seen'}>SUPER HOST</h3>
